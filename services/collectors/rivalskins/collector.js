...
export const COLLECTOR_ID = "rivalskins";
export const SOURCE_TYPE = "rivalskins";

export const TITLE_MAX_LENGTH = 140;
export const FALLBACK_TITLE = "Витік скіна Marvel Rivals (RivalSkins)";
...
export class RivalSkinsCollector extends BaseNewsCollector {
  static definition = DEFINITION;

  constructor({ config, db, bot }) {
    super({ config, db, bot });
    this.fetcher = new RivalSkinsFeedFetcher(config.rivalskins_feed_url);
  }
